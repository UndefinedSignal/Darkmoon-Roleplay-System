...
--[[
	...
	DarkmoonAurasFrameClearButton:HookScript("OnClick", function()	RPSCoreFramework:Search(RPSCoreFramework.Interface.Auras, DarkmoonAurasFrame.searchBox:GetText());	RPSCoreFramework:GenerateScrollMenu() end);
