...
RPSCoreFramework.Interface.Auras = {
	...
	{248,"Облик безды", "Аура. Персонаж входит в облик бездны и парит над землёй", 15000, 0, 0},
	...
	{251,"Держать котенка", "Аура. Персонаж держит котика и гладит его", 1000, 0, 0},
	{252,"Зазубренные костяные крылья", "Аура. Костяные крылья за спиной персонажа", 50000, 0, 0},
	{253,"Золотой слиток", "Аура. Персонаж несет огромный золотой слиток!", 5000, 0, 0},
	{254,"Золотая миска", "Аура. Персонаж держит в руках золотую миску с драгоценностями", 5000, 0, 0},
	{255,"Большие крылья", "Аура. Большие крылья охотников на демонов за спиной персонажа", 50000, 0, 0},
	{256,"Персональный барьер", "Ауру. На персонажа накладывается щит в форме прозрачного, фиолетового шара", 10000, 0, 0}
}
