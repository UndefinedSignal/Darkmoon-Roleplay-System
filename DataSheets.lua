...
RPSCoreFramework.Interface.Auras = {
	...
	{257,"Голубоватая дымка", "Аура. Персонаж окружен голубоватой дымкой", 5000, 0, 0},
	{258,"Зеленое свечение рук 2", "Аура. Руки персонажи начинают гореть зеленым огнем с трассирующими лучами", 10000, 0, 0},
	{259,"Арканная тюрьма", "Аура. Персонажа окружают арканные цепи", 1000, 0, 0},
	{260,"Нефтяная пленка", "Аура. Персонаж покрывается нефтяной пленкой и чернеет", 1000, 0, 0},
	{258,"Аура призрака", "Аура. Персонаж начинает выглядеть как призрак", 10000, 0, 0},
	{259,"Электрическая аура", "Аура. Персонаж окружен вспышками электромолний", 10000, 0, 0},
	{260,"Волны тьмы", "Аура. От персонажа вверх в воздух вздываются пафосные волны тьмы", 10000, 0, 0},
	{259,"Огненный щит Алекстразы", "Аура. Персонаж окружен огненным щитом", 15000, 0, 0},
	{260,"Синяя дымка", "Аура. От персонажа исходит синяя дымка ", 5000, 0, 0},
	{261,"Хождение по воде", "Аура. Хождение по воде шамана", 5000, 0, 0},
	{260,"Арканический круг", "Анимация. Персонаж произносит заклинание, окруженным эпическим арканическим кругом", 20000, 0, 0},
	{261,"Баллоны акваланга", "На спину. Баллоны акваланга на спине", 5000, 0, 0},
	{262,"Столп света с молниями", "Аура. Персонаж окружен столпом света с молниями", 20000, 0, 0},
	{261,"Щит темного пламени", "Аура. Персонаж окружен щитом темного пламени", 15000, 0, 0},
	{262,"Открыть портал", "Аура. Над персонажем открывается портал", 10000, 0, 0},
	{263,"Вихрь воздуха у ног", "Аура. У ног версонажа циркулярный вихрь воздуха. Эпично", 10000, 0, 0},
	{262,"Морской циклон", "Аура. Персонаж находится внутри мощнейшего морского циклона", 50000, 0, 0},
	{263,"Аура пожаротушителя", "Анимация. Персонаж тушит, у него в руках шланг, из которого бьет струя, на спине баллоны", 5000, 0, 0},
	{264,"Мытье", "Анимация. Персонаж что-то моет перед собой", 1000, 0, 0},
	{265,"Красное излучение", "Анимация. Вокруг персонажа красное магическое излучение", 10000, 0, 0}
}
